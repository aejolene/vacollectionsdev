Virginia Archaeological Collections Repositories Map
========
### This is very much a work in progress.
Currently it's mostly just plunked right into the BootLeaf code. It's ugly.

### Don't trust the data for now
These data come from the COVA Collections Survey, but may be refined. Attributes currently on the  map will be substantially enhanced and expanded. This is a development version of the map. Stay tuned for a stable version hosted on cova-inc.org. 
